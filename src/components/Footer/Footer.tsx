        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerSection}>
            ...
            <div className={styles.socialLinks}>
              <a href="https://github.com/fluxnodeai/GRAPHNEXUS" className={styles.socialLink} title="GitHub Repository">
              ...
              <a href="https://discord.gg/4BGmMscJ" className={styles.socialLink} title="Discord Community">
                <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className={styles.linkList}>
              <li><a href="https://github.com/fluxnodeai/GRAPHNEXUS" className={styles.footerLink}>Source Code</a></li>
              <li><a href="https://discord.gg/4BGmMscJ" className={styles.footerLink}>Join Discord</a></li>
              <li><a href="https://github.com/fluxnodeai/GRAPHNEXUS/issues" className={styles.footerLink}>Issues</a></li>
            </ul>
          </div>
        </div>
