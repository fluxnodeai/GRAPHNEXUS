      ...
      <div className={styles.headerContent}>
        ...
        <nav className={styles.nav}>
          ...
          <div className={styles.communitySection}>
            {/* Discord Community */}
            <a href="https://discord.gg/4BGmMscJ" target="_blank" rel="noopener noreferrer" className={styles.discordButton}>
            ...
            {/* GitHub CTA */}
            <a href="https://github.com/fluxnodeai/GRAPHNEXUS" target="_blank" rel="noopener noreferrer" className={styles.githubButton}>
