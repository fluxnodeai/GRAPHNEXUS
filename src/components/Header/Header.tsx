      ...
      <div className={styles.headerContent}>
        ...
        <nav className={styles.nav}>
          <div className={styles.navLinks}>
            <Link href="/graph" className={`${styles.navLink} ${styles.navFeatured}`}>
              ...
              <span className={styles.navText}>Build Graph</span>
              <span className={styles.navBadge}>Visual Tools</span>
            </Link>
          ...
          <div className={styles.communitySection}>
            {/* Discord Community */}
            <a href="https://discord.gg/graphnexus" target="_blank" rel="noopener noreferrer" className={styles.discordButton}>
            ...
            {/* GitHub CTA */}
            <a href="https://github.com/graphnexus/graphnexus" target="_blank" rel="noopener noreferrer" className={styles.githubButton}>
